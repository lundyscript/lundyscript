    ...
    switch (mainCommand) {
      ...
      case "performance":
        if (!monkeyTypeData && !wakaTimeData) {
          ...
          const start = new Date(wakaTimeData.profile.range.start);
          const end = new Date(wakaTimeData.profile.range.end);
          let categories = [];
          let category:any[] = [];
          const raw = wakaTimeData.result.categories;
            ...
            <div>
              <table>
                <tbody>
                  ...
                  <tr>
                    <td colSpan={2}>The total time i spent on coding activity session time with <a href="https://wakatime.com/" target="_blank" className="underline italic hover:text-[#B3FC03]">wakatime<span className="text-md">»</span></a> metrics since i joined on <HyperText as={"span"} animateOnHover={false} className="text-[#B3FC03] lowercase">{start.toLocaleDateString("ID")}</HyperText> until now <HyperText as={"span"} animateOnHover={false} className="text-[#B3FC03] lowercase">{end.toLocaleDateString("ID")}</HyperText> is <HyperText as={"span"} animateOnHover={false} className="text-[#B3FC03] lowercase">{wakaTimeData.profile.text}</HyperText></td>
                  </tr>
                  <tr>
                    <td>Over the Last 7 Days</td>
                    <td>: <HyperText as={"span"} animateOnHover={false} className="text-[#B3FC03] lowercase">{wakaTimeData.result.human_readable_total}</HyperText></td>
                  </tr>
                  <tr>
                    <td>Daily Average</td>
                    <td>: <HyperText as={"span"} animateOnHover={false} className="text-[#B3FC03] lowercase">{wakaTimeData.result.human_readable_daily_average}</HyperText></td>
                  </tr>
      ...
      case "projects":
        response = (
          <div>
            <ul>
              <li>
                <a href="https://www.langitbirubanyuwangi.com/" target="_blank" rel="noopener noreferrer" className="text-[#B3FC03]"><HyperText as={"span"} animateOnHover={false}>Langit Biru Banyuwangi v1.0</HyperText><span className="text-white/50"> | </span><span className="text-white/50 hover:text-[#B3FC03] hover:underline hover:underline-offset-4">langitbirubanyuwangi.com<svg className="inline ml-1" data-testid="geist-icon" height="16" strokeLinejoin="round" viewBox="0 0 16 16" width="16"><path d="M11.5 9.75V11.25C11.5 11.3881 11.3881 11.5 11.25 11.5H4.75C4.61193 11.5 4.5 11.3881 4.5 11.25L4.5 4.75C4.5 4.61193 4.61193 4.5 4.75 4.5H6.25H7V3H6.25H4.75C3.7835 3 3 3.7835 3 4.75V11.25C3 12.2165 3.7835 13 4.75 13H11.25C12.2165 13 13 12.2165 13 11.25V9.75V9H11.5V9.75ZM8.5 3H9.25H12.2495C12.6637 3 12.9995 3.33579 12.9995 3.75V6.75V7.5H11.4995V6.75V5.56066L8.53033 8.52978L8 9.06011L6.93934 7.99945L7.46967 7.46912L10.4388 4.5H9.25H8.5V3Z" fill="currentColor"></path></svg></span></a>
                <p>Content Management System (CMS) Platform Travel Agent</p>
                <dl>2026 | Build with NextJSand, TailwindCSS and PostgreSQL</dl>
                <br />
              </li>
              <li>
                <a href="https://github.com/lundyscript/lundyscript.git" target="_blank" rel="noopener noreferrer" className="text-[#B3FC03]"><HyperText as={"span"} animateOnHover={false}>LUNDYSCRIPT v4.0</HyperText><span className="text-white/50"> | </span><span className="text-white/50 hover:text-[#B3FC03] hover:underline hover:underline-offset-4">lundyscript.site<svg className="inline ml-1" data-testid="geist-icon" height="16" strokeLinejoin="round" viewBox="0 0 16 16" width="16"><path d="M11.5 9.75V11.25C11.5 11.3881 11.3881 11.5 11.25 11.5H4.75C4.61193 11.5 4.5 11.3881 4.5 11.25L4.5 4.75C4.5 4.61193 4.61193 4.5 4.75 4.5H6.25H7V3H6.25H4.75C3.7835 3 3 3.7835 3 4.75V11.25C3 12.2165 3.7835 13 4.75 13H11.25C12.2165 13 13 12.2165 13 11.25V9.75V9H11.5V9.75ZM8.5 3H9.25H12.2495C12.6637 3 12.9995 3.33579 12.9995 3.75V6.75V7.5H11.4995V6.75V5.56066L8.53033 8.52978L8 9.06011L6.93934 7.99945L7.46967 7.46912L10.4388 4.5H9.25H8.5V3Z" fill="currentColor"></path></svg></span></a>
